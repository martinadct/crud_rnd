...
<html lang="en">
  <head>
	...
	<link rel="icon" href="assets/images/sekolah.png" type="image/ico" />

    <title> Academic Information Center </title>
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" >
                  <a href="#" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <img src="assets/images/foto.jpg" alt="">Martina Dct
                  </a>
                  <div class="dropdown-menu dropdown-usermenu pull-right" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item"  href="#"> Profile</a>
                      <a class="dropdown-item"  href="#">
                        <span class="badge bg-red pull-right">75%</span>
                        <span>Settings</span>
                      </a>
      ...
      switch ($queries['page']) {
        ...
        <footer>
          <div class="pull-right">
            Copyright @ 2021 Aplikasi Akademik : Martina Dct
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
